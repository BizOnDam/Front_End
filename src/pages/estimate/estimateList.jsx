...
function EstimateList() {
  ...
  // 로딩 중이거나 에러가 있을 때만 LoadingOrError 컴포넌트 표시
  if (loading) {
          ...
          <div className="card-body">
            <div className="table-responsive">
              <table className="table table-hover">
                ...
                <tbody>
                  {ongoing.length === 0 ? (
                    <tr><td colSpan={6} className="text-center text-muted">진행중인 견적이 없습니다.</td></tr>
                  ) : (
                    paginatedOngoing.map(estimate => {
                      ...
                      return (
                        <tr key={request.request_id}>
                          ...
                          <td>{formatDateToYYYYMMDD(request.created_at)}</td>
                          <td>{formatDateToYYYYMMDD(request.due_date)}</td>
                          <td>
          ...
          <div className="card-body">
            <div className="table-responsive">
              <table className="table table-hover">
                ...
                <tbody>
                  {completed.length === 0 ? (
                    <tr><td colSpan={7} className="text-center text-muted">완료된 견적이 없습니다.</td></tr>
                  ) : (
                    paginatedCompleted.map(estimate => {
                      ...
                      return (
                        <tr key={request.request_id}>
                          ...
                          <td>{status === 3 ? formatDateToYYYYMMDD(response?.created_at) || '-' : '-'}</td>
                          <td>
